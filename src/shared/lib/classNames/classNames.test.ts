...
describe('classNames', () => {
    ...
    test('with additional class and options', () => {
        ...
        expect(
            classNames('someClass', { hovered: true, scrolleble: true }, [
                'class1',
                'class2',
            ]),
        ).toBe(expected);
    ...
    test('with additional class and options without one', () => {
        ...
        expect(
            classNames('someClass', { hovered: true, scrolleble: false }, [
                'class1',
                'class2',
            ]),
        ).toBe(expected);
    ...
    test('with additional class and options with undefined', () => {
        const expected = 'someClass class1 class2 hovered';
        expect(
            classNames('someClass', { hovered: true, scrolleble: undefined }, [
                'class1',
                'class2',
            ]),
        ).toBe(expected);
